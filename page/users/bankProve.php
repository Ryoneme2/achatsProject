    ...
    <section class="container">
      <div class="row">
        <div class="col-md-12 mt-5">
          <div class="card">
            <div class="card-header bg-color-one d-flex align-items-center">
            ...
            <div class="card-body px-2 py-5">
              <div class="row mb-6 justify-content-center align-items-center">
                <div class="col-md-4 col-sm-12">
                  <label class="text-color-dark d-block text-center" for="Profile Image">Payment information</label>
                </div>
