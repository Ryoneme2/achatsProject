  ...
  ?>
    ...
    <div class="container mt-5">
      ...
      <div class="bg-content py-5 px-3">
        ...
        <div class="row">
          <div class="col-12 d-flex justify-content-center">
            <div class="util d-flex justify-content-between align-items-center my-3">
              <div class="d-flex">
                <div class="me-2">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 172 172" style=" fill:#000000;">
                    <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
              ...
              <div>
                <button class="btn_buy bg-color-one "><a class="text-decoration-none text-color-light fs-5" href="#">buy now</a></button>
              </div>
            </div>
          </div>
        </div>
        <div class="row d-flex justify-content-center">
          <div class="col-12 util">
            <h3 class="fs-4 text-color-dark">product name : <span class="fw-light fs-4"><?php echo $rowProduct['prod_name']  ?></span> </h3>
            <a>
              <p onclick="myFunction()" id="myBtn" class="text-decoration-underline text-color-dark">view more</p>
            </a>
            <div id="more">
              <h3 class="fs-4 text-color-dark">type : <span class="fw-light fs-4"><?php echo $rowProduct['prod_type']  ?></span> </h3>
              <div class="d-flex text-color-dark mt-4">
                <h3 class="fs-4 text-color-dark">color :</h3>
                <ul>
                  <?php
                  $allColor = explode(",", $rowProduct['prod_color']);

                  for ($i = 0; $i < count($allColor); $i++) {
                  ?>

                    <li class="fw-light fs-5"><?php echo $allColor[$i] ?></li>
                  <?php
              ...
              <div class="d-flex text-color-dark mt-1">
                <h3 class="fs-4 text-color-dark">size :</h3>
                <ul>
                  <?php
                  $allSize = explode(",", $rowProduct['prod_size']);

                  for ($i = 0; $i < count($allSize); $i++) {
                  ?>

                    <li class="fw-light fs-5 "><?php echo $allSize[$i] ?></li>
                  <?php
            ...
            <h3 class="fs-4 text-color-dark">price : <span class="fw-light fs-4"><?php echo number_format($rowProduct['prod_price']) ?> Baht</span> </h3>
          </div>
        </div>
        <!-- review -->
