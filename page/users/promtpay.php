...
<body class="overflow-hidden">
  ...
  if ($_SESSION['isLogin'] && $_SESSION['role'] == 'user') {
    ...
    // print("<pre>" . print_r($_SESSION['cartItems'], true) . "</pre>");
  ?>
    ...
    <section class="container-fluid vh-100 my-4">
      <div class="h-75 d-flex justify-content-center align-items-center">
        <div class="bg-white w-25 h-75 rounded d-flex justify-content-center align-items-center flex-column">
          <h2>Scan Here</h2>
          <div>
            <img src="<?php echo "https://promptpay.io/0631236001/" . $_SESSION['allPrice'] ?>" alt="">
          </div>
          <a class="bg-color-one text-white py-2 px-2 rounded-pill text-decoration-none mt-2" href="../../service/addToOrder.php">Confirm Order</a>
        </div>
      </div>
